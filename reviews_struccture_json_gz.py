"""
The following code builds an excel table to display the structure of the 'Reviews' json files.
...
# metadata_directory = os.path.join(project_dir, "Amazon Project - Data/Reviews")
